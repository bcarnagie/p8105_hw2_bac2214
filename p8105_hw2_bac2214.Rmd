...
```{r}
mr_trashwheel_df =
  read_excel("data/trashwheel.xlsx", sheet = "Mr. Trash Wheel", range = "A2:N549") |> janitor::clean_names() |> mutate(homes_powered = weight_tons * 500, trashwheel_name = "mr_trashwheel") |> relocate(trashwheel_name)
